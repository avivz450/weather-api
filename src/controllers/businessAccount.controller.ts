...
import businessService from  "../services/businessAccount.service.js"

class BusinessController {

    createAccount: RequestHandler = async (req, res) => {
    console.log("im in controller business")
    const users = await businessService.createBusinessAccount(req.body);
