...
class FamilyAccountRouter {
  ...
  constructor() {
    ...
    this.familyAccountRouter.get('/:account_id/:details_level', raw(accountMiddlewares.verifyGetAccount), raw(familyAccountController.getFamilyAccount));
    ...
    this.familyAccountRouter.patch('/remove-accounts/:account_id/:details_level', raw(familyMiddlewares.verifyCloseIndividuals), raw(familyAccountController.removeAccountsFromFamilyAccount));
