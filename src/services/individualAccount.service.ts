...
class IndividualAccountService {
    async createIndividualAccount(
        ...
        const individual_account_id =
            await individualAccountRepository.createIndividualAccount(payload);
        const individual_account =
            await individualAccountRepository.getIndividualAccountByAccountId(
    ...
    async getIndividualAccountByIndividualId(
