...
//     const timestamp = req.headers['x-timestamp'] as string;                        // Current Unix time (seconds).
...
//     const isValidSignature = authenticationService.validateSignatrues(signature as string, signature_to_compare);
