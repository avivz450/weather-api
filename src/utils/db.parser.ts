...
export function parseBusinessAccountQueryResult(query_result_obj: IBusinessAccountDB) {
  const { accountID, currencyCode, balance, statusName, companyID, companyName, context, addressID, countryCode, countryName, postalCode, city, region, streetName, streetNumber } = query_result_obj;
